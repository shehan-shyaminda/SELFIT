package com.codelabs.selfit.helpers;
...
public class SharedPreferencesManager {
    ...
    public static final String ADMINS_ID = "SELFIT_PREF_FILE_IS_ADMIN";
    public static final String TRAINERS_ID = "SELFIT_PREF_FILE_TRAINER_ID";
    public static final String USER_ID = "SELFIT_PREF_FILE_USER_ID";
    public static final String USER_REG_DATE = "SELFIT_PREF_FILE_USER_REG_DATE";
